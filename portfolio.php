        ...
        <div class="row vcenter pt80">
            <div class="col-lg-7">
                <div class="page-headings">
                    ...
                    <a href="contact-us.php" class="ree-btn  ree-btn-grdt1 mt40" data-aos="fade-in" data-aos-delay="800">Get Quote <i class="fas fa-arrow-right fa-btn"></i></a>
                </div>
            </div>
            <div class="col-lg-5">
				...
				<div class="row">
					<div class="col-lg-6 vcenter">
						<div class="cta-heading">
							...
							<a href="contact-us.php" class="ree-btn  ree-btn-grdt1 mw-80 mt40">Start Your Project <i class="fas fa-arrow-right fa-btn"></i></a>
						</div>
					</div>
					<div class="col-lg-6 vcenter">
